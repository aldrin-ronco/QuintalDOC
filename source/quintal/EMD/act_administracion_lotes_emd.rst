...
============
	...
	Los lotes pueden ser clasificados en varios tipos según su consecutivo y algunas otras normas, como está especificado en: `Creación de tipos de lote y selección de consecutivos EMD <>`_
	...
	- Escoja el tipo de Lote. Vea, `Creación de tipos de lote y selección de consecutivos EMD <>`_
	...
	- Seleccione el Electrodo de Lectura. Vea, `Administración de electrodos de lectura EMD <>`_
	...
	- En la ventana emergente podrá seleccionar la presentación para el ingreso y la calidad. Ambas opciones son especificadas en las `configuraciones avanzadas de la materia prima`_
