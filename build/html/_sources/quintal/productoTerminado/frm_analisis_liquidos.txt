...
---------------------------------
	...
	- Verá una ventana emergente con un listado de vehículos/conductores ya asignados previamente en **6.4** *Administración de despacho productos líquidos*; puede buscar el vehículo requerido por la fecha de creación del peso de entrada, por el peso y por el nombre del conductor

					.. figure:: images/liquidos/2.jpg
 							:align: center
